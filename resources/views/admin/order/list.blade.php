                  ...
                  <tr>
                    ...
                    <td>
                        @if($order->status == 'ready-to-ship')
                          <button class="btn btn-primary btn-sm" disabled>Ready To Ship</button>
                        @else
                        <a href="{{route('pharmacy.admin.order.ship',$order->id)}}" onClick="confirm('Ready To Ship?');" class="btn btn-primary btn-sm">Ready To Ship</a>
                        @endif
                    </td>
                  </tr>
                  @endforeach
